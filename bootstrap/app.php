...
$container['dispatcher'] = function($container) {
    ...
    $dispatcher->addListener(
        'endpoint.down', 
        [new \App\Listeners\EndpointDownSmsNotification($container->twilio), 'handle']
    );
    $dispatcher->addListener(
        'endpoint.up', 
        [new \App\Listeners\EndpointIsUpSmsNotification($container->twilio), 'handle']
    );
...
$container['console'] = function($container) {
    ...
    $application->add(new \App\Console\Commands\RunCommand($container->guzzle, $container->dispatcher));
